...
for tr_i in tracer_arr:   
    ...
    emu_pfxselprop = emulator_basedir + "emulate_bitw_v1.1/out/" + args.mockver + "/" + "FAemu_m" + args.real + "_" + args.galcap + "_" + new_target + "_llen" + args.foflinklen + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco + "_truent_cfc_"
    ...
    emu_pfxout = emulator_basedir + "emulate_bitw_v1.1/out/" + args.mockver + "/FAemu_m" + args.real + "_" + args.galcap + "_" + new_target + "_llen" + args.foflinklen + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco +  "_truent_cfc_nbits217_"   
    ...
    if args.emulate == 'n':
        ...
        outputfnemu = emulator_basedir + "emulate_bitw_v1.1/log/" + args.mockver + "_emu_" + new_target + "_llen"+ args.foflinklen +"_" + args.galcap + "_m" + args.real + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco + "_datatrain.txt"
        errorfnemu = emulator_basedir + "emulate_bitw_v1.1/log/" + "ERR_" + args.mockver + "_emu_" + new_target + "_llen"+ args.foflinklen +"_" + args.galcap + "_m" + args.real + "_beta0_" + args.emubeta0 + "_beta1_" + args.emubeta1 + "_deco_" + args.deco + "_datatrain.txt"
        print(cmd_string7)
        print(cmd_string8)
        ...
        if not os.path.exists("/pscratch/sd/s/sikandar/FFA_Covariances/Fitted_Covariances/" + f"ll_{args.foflinklen}_beta0_{args.emubeta0}_beta1_{args.emubeta1}_deco_{args.deco}/" + "mock" + str(args.real) + "/"):
            os.makedirs("/pscratch/sd/s/sikandar/FFA_Covariances/Fitted_Covariances/" + f"ll_{args.foflinklen}_beta0_{args.emubeta0}_beta1_{args.emubeta1}_deco_{args.deco}/" + "mock" + str(args.real) + "/")
            print('made ' + "/pscratch/sd/s/sikandar/FFA_Covariances/Fitted_Covariances/" + f"ll_{args.foflinklen}_beta0_{args.emubeta0}_beta1_{args.emubeta1}_deco_{args.deco}/" + "mock" + str(args.real) + "/")
        outdir_data = "/pscratch/sd/s/sikandar/FFA_Covariances/Fitted_Covariances/" + f"ll_{args.foflinklen}_beta0_{args.emubeta0}_beta1_{args.emubeta1}_deco_{args.deco}/" + "mock" + str(args.real) + "/" + "ffa_full_" + target_write_name + ".fits"
