...
for tr_i in tracer_arr:   
    ...
    emu_pfxselprop = emulator_basedir + "emulate_bitw_v1.1/out/" + args.mockver + "/" + "FAemu_m" + args.real + "_" + args.galcap + "_" + new_target + "_llen" + args.foflinklen + "_truent_cfc_"
    emu_naminqref = emulator_basedir + "emulate_bitw_v1.1/out/TrainedEmulator_Data/FAemu_data_" + args.galcap + "_" + new_target + "_llen" + args.foflinklen + "_truent_cfc_antico_deco0.1_beta0_indselfrac_cfc_qm.dat"
    emu_pfxout = emulator_basedir + "emulate_bitw_v1.1/out/" + args.mockver + "/FAemu_m" + args.real + "_" + args.galcap + "_" + new_target + "_llen" + args.foflinklen + "_truent_cfc_nbits217_"
    ...
    # Write the modified content back to the same file
    file_path_new_emu = emulator_basedir + "/emulate_bitw_v1.1/INI_emulate_bitw_lightcone_ntile_%s_%s_ll_%s.txt"%(args.mockver, args.real, args.foflinklen)
    ...
    if args.emulate == 'n':
        ...
        # WEIGHTS
        nwe = 9
        namin_fbw = emulator_basedir + "emulate_bitw_v1.1/out/" + args.mockver + "/FAemu_m" + args.real + "_" + args.galcap + "_" + new_target + "_llen"+ args.foflinklen +"_truent_cfc_nbits217_" + "wemu_unformatted.dat"
        ...
        namout_tot = emu_out_dir + args.mockver + '_corr_clustering_cat_FAemu_m' + args.real + '_' + args.galcap + '_' + new_target + '_llen'+ args.foflinklen +'_truent_cfc.fits'
        ...
        emu_in = Table.read(emu_out_dir + args.mockver + '_corr_clustering_cat_FAemu_m' + args.real + '_' + args.galcap + '_' + new_target + '_llen'+ args.foflinklen +'_truent_cfc.fits')
